# /users/kkousour/JMEDev/JetHLT/V19 (CMSSW_7_1_4_patch1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/kkousour/JMEDev/JetHLT/V19')
)
...
process.HLTAK4CaloJetsCorrectionSequence = cms.Sequence( process.hltFixedGridRhoFastjetAllCalo + process.hltAK4CaloJetsCorrectedIDPassed )
...
if 'hltTrigReport' in process.__dict__:
    process.hltTrigReport.HLTriggerResults                    = cms.InputTag( 'TriggerResults', '', 'TTT' )

if 'hltPreExpressCosmicsOutputSmart' in process.__dict__:
    process.hltPreExpressCosmicsOutputSmart.hltResults = cms.InputTag( 'TriggerResults', '', 'TTT' )

if 'hltPreExpressOutputSmart' in process.__dict__:
    process.hltPreExpressOutputSmart.hltResults        = cms.InputTag( 'TriggerResults', '', 'TTT' )

if 'hltPreDQMForHIOutputSmart' in process.__dict__:
    process.hltPreDQMForHIOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'TTT' )

if 'hltPreDQMForPPOutputSmart' in process.__dict__:
    process.hltPreDQMForPPOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'TTT' )

if 'hltPreHLTDQMResultsOutputSmart' in process.__dict__:
    process.hltPreHLTDQMResultsOutputSmart.hltResults  = cms.InputTag( 'TriggerResults', '', 'TTT' )

if 'hltPreHLTDQMOutputSmart' in process.__dict__:
    process.hltPreHLTDQMOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'TTT' )

if 'hltPreHLTMONOutputSmart' in process.__dict__:
    process.hltPreHLTMONOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'TTT' )

if 'hltDQMHLTScalers' in process.__dict__:
    process.hltDQMHLTScalers.triggerResults                   = cms.InputTag( 'TriggerResults', '', 'TTT' )
    process.hltDQMHLTScalers.processname                      = 'TTT'

if 'hltDQML1SeedLogicScalers' in process.__dict__:
    process.hltDQML1SeedLogicScalers.processname              = 'TTT'
...
process.tfJets = cms.Path(process.HLTBeginSequence+process.HLTAK4PFJetsSequence+process.hltPFJetsCorrectedMatchedToL1)
...
process.hltOutputFULL.outputCommands = cms.untracked.vstring( 'drop *', 
    'keep recoPFJets_hltAK4PFJets_*_*' ,
    'keep recoPFJets_hltAK4PFJetsCorrected_*_*',
    'keep recoPFJets_hltPFJetsCorrectedMatchedToL1_*_*',
    ...
    'drop edmHepMCProduct_generator__SIM',
