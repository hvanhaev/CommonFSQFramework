...
process.CondDBCommon.connect = 'sqlite_file:START42_V16A.db' 
...
process.dbWriterAK5Calo = cms.EDAnalyzer('JetCorrectorDBWriter', 
   era    = cms.untracked.string('START42_V16A'), 
...
process.p = cms.Path( process.dbWriterAK5Calo * process.dbWriterAK5PF ) 
