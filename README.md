...
In order to get the code compiled you need to install a CMSSW release CMSSW_7_4_X with X >= 14. 

<b>This branch version was intended for analysis of early Run II 2015 data. Should be superseded by CMSSW_76X branch.</b> 
