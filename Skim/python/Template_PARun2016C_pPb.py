...
dsFile="CommonFSQFramework/Skim/python/ds_PARun2016C_pPb_v1.txt"
...
def json(ds):
    realData = isData(ds)
    if realData:
        if "PARun2016C" in ds: return "CommonFSQFramework/Skim/lumi/HI8TeV_PromptReco_pPb_Run_285530.txt"
    else:
        return ""
...
def numEvents(ds):
    ...
    # pPb MC
    if "ReggeGribovPartonMC_EposLHC_pPb_4080_4080_DataBS" in name(ds): return 29837713
    if "hvanhaev-ReggeGribovPartonMC_EposLHC_4080_4080GeV_pPb_RECO_CastorNoiseFix" in ds: return 441000
...
def GT(ds):
    ...
    if "hvanhaev-ReggeGribovPartonMC_EposLHC_4080_4080GeV_pPb_RECO_CastorNoiseFix" in ds: return "80X_mcRun2_pA_v4"
...
def XS(ds):
    ...
    # Give all XS in pb
    s = {}
    s["ReggeGribovPartonMC_EposLHC_pPb_4080_4080_DataBS"] = 2069160000000.0 # 5 TeV cross section
