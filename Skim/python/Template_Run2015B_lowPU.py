...
dsFile="CommonFSQFramework/Skim/python/ds_Run2015B_lowPU_v1.txt"
...
def name(ds):
    ...
    if "PU1p3RealisticRecodebug" in ds: return split[1]+"_PU1p3"
...
def json(ds):
    realData = isData(ds)
    if realData:
        if "Run2015B" in ds: return "CommonFSQFramework/Skim/lumi/Run2015B_lowPU.json"
    else:
        return ""
...
def GT(ds):
    ...
    if isData(ds) and "Run2015B-v1_LowPU_RERECO_74X_dataRun2_Prompt_v2_withCustomCond-v1" in ds: return "74X_dataRun2_Prompt_v2" 
	
    # 3.8T MC GT
    if "NoPU_castor_MCRUN2_74_V8" in ds: return "MCRUN2_74_V8" 
    if "NoPURawReco_castor_MCRUN2_74_V8B" in ds: return "MCRUN2_74_V8B"
    if "741_p1_mcRun2_Realistic_50ns_v0" in ds: return "741_p1_mcRun2_Realistic_50ns_v0"
...
def XS(ds):
    ...
    s["MinBias_TuneCUETP8M1_13TeV-pythia8_PU1p3"] = 78418400000.0
    s["ReggeGribovPartonMC_13TeV-EPOS_PU1p3"] = 78418400000.0
    s["MinBias_TuneCUETHS1_13TeV-herwigpp"] = 36460000000.0
    s["MinBias_TuneCUETHS1_13TeV-herwigpp_PU1p3"] = 36460000000.0
