...
dsFile="CommonFSQFramework/Skim/python/ds_Run2016B_2016MC.txt"
...
def numEvents(ds):
    ...
    # 3.8T MC
    if "HINPFJets/Run2016B" in name(ds): return 6034698
    if "FSQJets/Run2016B" in name(ds): return 5395825
    if "L1MinimumBias0" in name(ds) : return 46822816
    if "L1MinimumBias1" in name(ds) : return 45239175
    if "L1MinimumBias2" in name(ds) : return 45155399
    if "L1MinimumBias3" in name(ds) : return 45239250
    if "L1MinimumBias4" in name(ds) : return 45237239
    if "L1MinimumBias5" in name(ds) : return 45238013
    if "L1MinimumBias6" in name(ds) : return 45238607
    if "L1MinimumBias7" in name(ds) : return 45238635
    if "L1MinimumBias8" in name(ds) : return 45236314
    if "L1MinimumBias9" in name(ds) : return 45237842
...
def GT(ds):
    if isData(ds) and "HINPFJets" and "Run2016B" in ds: return "80X_dataRun2_2016SeptRepro_v7"
    if isData(ds) and "FSQJets" and "Run2016B" in ds: return "80X_dataRun2_2016SeptRepro_v7"
    if isData(ds) and "L1MinimumBias" and "Run2016B" in ds: return "80X_dataRun2_2016SeptRepro_v7"
