...
def get(todo):
    ...
    defs["TriggersRun2016H"]  = cms.PSet(
        ...
        process = cms.string("HLT"),
        storePrescales = cms.bool(True),
        triggers = cms.vstring("AK4PFJet30","DiPFJet15","DiPFJet25","DiPFJet15_FB","PFJet15","PFJet25","L1MinimumBiasHFOR0","L1MinimumBiasHFOR1","L1MinimumBiasHFOR2","L1MinimumBiasHFOR3","L1MinimumBiasHFOR4","L1MinimumBiasHFOR5","L1MinimumBiasHFOR6","L1MinimumBiasHFOR7","L1MinimumBiasHFOR8","L1MinimumBiasHFOR9"),
        AK4PFJet30 = cms.vstring("HLT_AK4PFJet30_v7"),
        DiPFJet15 = cms.vstring("HLT_DiPFJet15_NoCaloMatched_v5"),
        DiPFJet15_FB = cms.vstring("HLT_DiPFJet15_FBEta3_NoCaloMatched_v6"),
